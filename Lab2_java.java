...
System.out.println("enter the number of credits for each subject:");
for(int i=0;i<5;i++)
...
for(int i=0;i<5;i++)
{
System.out.println("marks of eaxh subject"+(i+1)+"="+marks[i]);
...
System.out.println("invalid marks for subject"+(i+1)+"entered try agian");
